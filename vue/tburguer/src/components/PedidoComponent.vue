	...
	<div> 
		<form id="pedido-form">
			<div id="foto-content">
				...
				{{ burguer && burguer.nome ? burguer.nome : "_"}}
				</p>
...
<script>
	export default {
		...
		methods: {
			...
			async getOpcionais (){
				const response = await fetch("http://tburguer.wiremockapi.cloud/opcionais/");
				const responseJson = await response.json();
				this.listaComplementos = responseJson.complementos;
